...
use DIISH\CommonBundle\Entity\Group;
use DIISH\CommonBundle\Entity\GroupRepository;
use DIISH\AdminBundle\Form\GroupRegistrationType;
use DIISH\AdminBundle\Form\GroupEditType;
...
class GroupController extends AppController
{
    ...
    public function indexAction(Request $request)
    {
        $userRepository = $this->get('doctrine')->
                getRepository('DIISHCommonBundle:Group');
    ...
    {
        $group = new Group();
        $form = $this->createForm(new GroupRegistrationType(), $group, array(
            'action' => $this->generateUrl('admin_group_register'),
            'method' => 'POST',
        ));
    ...
    public function confirmAction(Request $request)
    {
        ...
        if ('POST' === $request->getMethod()) {
            ...
            try {
                ...
                $repository = $em->getRepository('DIISHCommonBundle:Group');
    ...
    public function editAction(Request $request, $id)
    {
        ...
        $form = $this->createForm(new GroupEditType(), $group, array(
            'action' => $this->generateUrl('admin_group_edit', array('id' => $id)),
            'method' => 'POST',
        ));
